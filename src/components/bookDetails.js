...
function BookDetail() {
  ...
  console.log("BookDetail component rendered with bookId:", bookId)
        ...
        if (data.success && data.result) {
          ...
          if (foundBook) {
            setBook({
              ...
              imageUrl: foundBook.bookImage || `/placeholder.svg?height=400&width=300`,
              thumbnails: [
                foundBook.bookImage || `/placeholder.svg?height=100&width=80`,
                "/placeholder.svg?height=100&width=80&text=Alt+View",
              ],
